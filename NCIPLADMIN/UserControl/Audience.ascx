<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Audience.ascx.cs" Inherits="PubEntAdmin.UserControl.Audience" %>
...
<div class="lookupnew">
    <div class="lookupfld">
        <asp:Label runat="server" AssociatedControlID="txtAudName">Description</asp:Label>
        <asp:TextBox ID="txtAudName" runat="server"></asp:TextBox>
    </div>
    <div class="lookupbtn">
...
<asp:DataGrid ID="gvResult" runat="server" AutoGenerateColumns="False" CellPadding="4"
    ...
    <Columns>
        <asp:BoundColumn Visible="False" DataField="AudID"></asp:BoundColumn>
        <asp:TemplateColumn HeaderText="Audience Description">
            <EditItemTemplate>
                <asp:TextBox ID="txtAudName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.AudName")%>'
                    CssClass="audvalue"></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="lblAudName" runat="server" Text=""></asp:Label>
            </ItemTemplate>
        </asp:TemplateColumn>
