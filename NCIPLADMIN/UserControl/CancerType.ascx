<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CancerType.ascx.cs" Inherits="PubEntAdmin.UserControl.CancerType" %>
...
<h3>Add New Cancer Type</h3>
<div class="lookupnew">
    <div class="lookupfld">
        <asp:Label ID="Label2" runat="server" AssociatedControlID="txtCtpyName">
        Cancer Type Description</asp:Label>
        <asp:TextBox ID="txtCtpyName" runat="server"></asp:TextBox>
    </div>
    <div class="lookupbtn">
...
<h3>Edit Existing Cancer Type</h3>
<asp:DataGrid ID="gvResult" runat="server" AutoGenerateColumns="False" CellPadding="4"
    ...
    <Columns>
        <asp:BoundColumn Visible="False" DataField="CancerTypeID"></asp:BoundColumn>
        <asp:TemplateColumn HeaderText="Cancer Type Description">
            <EditItemTemplate>
                <asp:TextBox ID="txtCtpyName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CancerTypeName")%>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="lblCtpyName" runat="server" Text=""></asp:Label>
            </ItemTemplate>
        </asp:TemplateColumn>
