<%@ Page Title="Search Results - NCI Publications Locator" Language="C#" MasterPageFile="~/pubmaster.Master"
    AutoEventWireup="true" CodeBehind="newupdated.aspx.cs" Inherits="PubEnt.newupdated" %>
   ...
   <%-- <asp:PlaceHolder ID="MessagePlaceHolder" runat="server"></asp:PlaceHolder>
    ...
    <div id="serp"><a id="skiptocontent" tabindex="-1"></a>
        ...
        <div id="divNewUpdated" runat="server" visible="false" class="indentwrap">
            ...
            <p>
                New and updated publications from NCI released in the <strong>last month</strong>.</p>
        </div>
                            ...
                            <div class="serpcols">
                                ...
                                <div class="col serporder">
                                    ...
                                    <asp:ImageButton ID="OrderPublication" runat="server" Text="Order Publication" Visible="False"
                                        ...
                                        OnCommand='DisplayModalPopUp' OnClientClick="javascript:_gaq.push(['_trackEvent','Ordering','Submit','Order Item']);" />
                                    ...
                                    <asp:HyperLink ID="HtmlLink" runat="server" Visible="false" Target="_blank" Text="View"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','HTML','HtmlLink']);" />
                                    ...
                                    <asp:HyperLink ID="PdfLink" runat="server" Visible="false" Target="_blank" Text="Print"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','PDF','PdfLink']);" />
                                    <asp:HyperLink ID="KindleLink" runat="server" Visible="false" Text="<br>Download to Kindle"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','Kindle','KindleLink']);" />
                                    <asp:HyperLink ID="EpubLink" runat="server" Visible="false" Text="<br>Download to other E-readers"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','Epub','EpubLink']);" />
                                    <br />
    ...
    <div>
        ...
        <asp:Panel ID="PubOrderPanel" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div class="orderbtns">
                <asp:HyperLink ID="PubOrderLink" runat="server" CssClass="btn goAction" onclick="javascript:_gaq.push(['_trackEvent','Ordering','Submit','Add to Cart']);">                      Add to Cart</asp:HyperLink>
        ...
        <asp:Panel ID="PubCoverOrderPanel" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div class="orderbtns">
                <asp:HyperLink ID="PubCoverOrderLink" CssClass="btn goAction" runat="server" onclick="javascript:_gaq.push(['_trackEvent','Ordering','Submit','Add to Cart']);">
