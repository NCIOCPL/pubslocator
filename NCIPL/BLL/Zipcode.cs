...
/// </summary>
    ...
    public class Zipcode{
        ...
        public static Boolean isXPO(string state)
        {
            return (PubEnt.GlobalUtils.Const.XPOs.Contains(state.ToUpper()));
        }
        public static Zipcode GetCSZ(int z)
        {
            return (PubEnt.DAL2.DAL.GetCSZ(z));
        }
        public static KVPairCollection GetCities(int z)
        {
            return (PubEnt.DAL2.DAL.GetCities(z));
        }
