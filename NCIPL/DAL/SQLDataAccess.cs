...
namespace PubEnt.DAL
{
    public class DAL : System.Web.UI.Page
    {
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cw = db.GetStoredProcCommand("sp_NCIPL_getAnnouncements");
            using (System.Data.IDataReader dr = db.ExecuteReader(cw))
            {
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cw = db.GetStoredProcCommand("sp_NCIPL_SearchContains");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("sp_NCIPL_getpubsbycsv");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("sp_NCIPL_getRelatedProducts");
        ...
        public static ProductCollection GetNewUpdatedProducts(int type)
        {
            ...
            {
                case 1:
                    procname = "sp_NCIPL_GetNewUpdatedPubs";
                    break;
                case 2:
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("sp_NCIPL_getProductTranslations");
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("sp_NCIPL_getLetterIndex");
            return db.ExecuteReader(dbCommand);
        }
        ///End CR-28
