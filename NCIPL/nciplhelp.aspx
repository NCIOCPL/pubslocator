<%@ Page Title="Help with printing and ordering free National Cancer Institute publications - NCI Publications Locator"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="help" class="indentwrap">
        ...
        <p>
            ...
            Locator, <a href="https://pubs.cancer.gov">https://pubs.cancer.gov</a>.
        </p>
        ...
        <h4>How many copies can I order?</h4>
        <ul>
        ...
        <h4>If my organization’s needs exceed the order limit, how can we get more copies?</h4>
        <ul>
        ...
        <p>
            NCI publications are free. There are no handling charges for NCI publications.
        </p>
        ...
        <p>
            ...
            days. Please contact <a href="mailto:fakenci@fakegpo.gov">fakenci@fakegpo.gov</a> with any inquiries regarding your order.
        </p>
        <h4>Orders up to 20 items</h4>
        <p>
        ...
        <table class="table-default">
            <thead>
                <tr>
                    <th scope="col">Number of days after shipment to expect publications
                    </th>
                    <th scope="col">Shipping option
                    </th>
                    <th scope="col">Destinations available
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <th scope="row">10:30 a.m. the next day
                    </th>
                    <td>FedEx Priority Overnight or
                        <br />
                        UPS Next Day Air
                    </td>
                    <td>50 United States; Alaska and Hawaii may need extra time
                    </td>
                </tr>
                <tr>
                    <th scope="row">End of the 2<sup>nd</sup> business day
                        <br />
                        (4:30 p.m. for FedEx)
                    </th>
                    <td>FedEx 2Day or
                ...
                <tr>
                    <th scope="row">End of the 3<sup>rd</sup> business day
                        <br />
                        (4:30 p.m. for FedEx)
                    </th>
                    <td>FedEx Express Saver or
                        <br />
                        UPS 3 Day Select
                    </td>
                    <td>Continental 48 United States
                    </td>
                </tr>
                <tr>
                    <th scope="row">1–5 business days
                    </th>
                    <td>FedEx Ground or
                        <br />
                        UPS Ground
        ...
        <h4>
            <a id="apo"></a>Can people in Army Post Office or Fleet Post Office (APO or FPO)
            locations, U.S. territories and possessions order NCI publications?</h4>
        <p>
            Yes. There are some limitations for these orders:
        </p>
        <ul>
        ...
        <table class="table-default" id="intltable">
            <thead>
                <tr>
                    <th class="hthsmall" scope="col">If your address is
                    </th>
                    <th class="hthsmall" scope="col">Number of publications you can order
                    </th>
                    <th class="hthbig" scope="col">How to order
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <th scope="row">APO or FPO
                    </th>
                    <td>30 items total
                    </td>
                    <td>You can order online. To order more than 20 items, you must <a href="#register">register</a>.
                ...
                <tr>
                    <th scope="row">U.S. territories and possessions, such as Puerto Rico, U.S. Virgin Islands, Guam,
                        and American Samoa
                    </th>
                    <td>30 items total
                    </td>
                ...
                <tr>
                    <th scope="row">Another place outside the United States (international orders)
                    </th>
                    <td>None
                    </td>
                    <td>We cannot send international orders. Please visit <a href="nciplselfprint.aspx">Self-Printing
        ...
        <table class="table-default">
            <thead>
                <tr>
                    <th scope="col">The problem
                    </th>
                    <th scope="col">What will happen
                    </th>
            ...
            <tbody>
                <tr>
                    <th scope="row">We cannot validate your FedEx or UPS shipping number
                    </th>
                    <td>We will hold your order for 48 hours and try to contact you.
                        <br />
                        We will cancel the order if we cannot validate your shipping number after that time.
                    </td>
                    <td>Respond to our e-mail or phone call so we can correct your shipping number. If 48
                        hours has already passed, place a new order.
                    </td>
                </tr>
                <tr>
                    <th scope="row">Questions about a shipping charge
                    </th>
                    <td>Shipping charges are billed directly to your FedEx or UPS shipping number.
                        <br />
                        We cannot resolve billing questions.
                    </td>
                    <td>Please contact the person who handles your FedEx or UPS account.
                    </td>
                </tr>
                <tr>
                    <th scope="row">A mistake with my order
                    </th>
                    <td>We cannot make refunds or offer exchanges on orders after they have been shipped.
                        <br />
        ...
        <p>
            ...
            <a href="http://www.cancer.gov/contact">http://www.cancer.gov/contact</a> for options
