...
namespace PubEnt
{
    public partial class cannedsearchres : System.Web.UI.Page
    {   
        ...
        //{
        //    /// The following page directive can be specified in the aspx file to turn off page caching
        ...
        //{
        //    ProductCollection p = DAL.DAL.GetCannedSearchProducts(Int32.Parse (Session["PUBENT_CannedSearch"].ToString()));
        ...
        //            PubLastUpdateDate.Text = "<br/>" + PubLastUpdateDate.Text + "&nbsp;&nbsp;&nbsp;";
        ...
        //                string logmessage = "\r\n";
        //                logmessage += "Translation Pubs Error on cannedsearchres: " + "\r\n";
