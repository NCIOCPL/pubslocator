<%@ Page Title="Search Results - NCI Publications Locator" Language="C#" MasterPageFile="~/pubmaster.Master"
    AutoEventWireup="true" CodeBehind="cannedsearchres.aspx.cs" Inherits="PubEnt.cannedsearchres" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="serp"><a id="skiptocontent" tabindex="-1"></a>
        <div>
        ...
        <div id="divNewUpdated" runat="server" visible="false" class="indentwrap">
            ...
            <span class="headSerpCriteria">
                <asp:Literal ID="literalDesc" runat="server"></asp:Literal></span>
            <div class="borderline">
            </div>
            <h2>
                <span>New and updated publications from NCI released in the <strong>last month</strong>.</span></h2>
        </div>
                            ...
                            <div class="serpcols">
                                ...
                                <div class="col serporder">
                                    ...
                                    <asp:ImageButton ID="OrderPublication" runat="server" Text="Order Publication" Visible="False"
                                        ...
                                        OnCommand='DisplayModalPopUp' OnClientClick="javascript:_gaq.push(['_trackEvent','Ordering','Submit','Order Item']);NCIAnalytics.PubsLinkTrack('Order Item', this);" />
                                    ...
                                    <asp:HyperLink ID="HtmlLink" runat="server" Visible="false" Target="_blank" Text="View"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','HTML','HtmlLink']);NCIAnalytics.PubsLinkTrack('View Publication', this);" />
                                    ...
                                    <asp:HyperLink ID="PdfLink" runat="server" Visible="false" Target="_blank" Text="Print"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','PDF','PdfLink']);NCIAnalytics.PubsLinkTrack('Print Publication', this);" />
                                    <asp:HyperLink ID="KindleLink" runat="server" Visible="false" Text="<br>Download to Kindle"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','Kindle','KindleLink']);NCIAnalytics.PubsLinkTrack('Download to Kindle', this);" />
                                    <asp:HyperLink ID="EpubLink" runat="server" Visible="false" Text="<br>Download to other E-readers"
                                        CssClass="readaslinks" onclick="javascript:_gaq.push(['_trackEvent','External','Epub','EpubLink']);NCIAnalytics.PubsLinkTrack('Download to other E-readers', this);" />
                                    <br />
