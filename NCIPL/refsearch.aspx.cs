...
namespace PubEnt
{
    public partial class refsearch : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            ddlTOC.DataSource = KVPair.GetKVPair("sp_NCIPL_getCancerTypes");
            ...
            ddlCT.DataSource = KVPair.GetKVPair("sp_NCIPL_getSubjects");
            ...
            ddlAud.DataSource = KVPair.GetKVPair("sp_NCIPL_getAudience");
            ...
            ddlLan.DataSource = KVPair.GetKVPair("sp_NCIPL_getLanguages");
            ...
            ddlForm.DataSource = KVPair.GetKVPair("sp_NCIPL_getProductFormats");
            ...
            ddlColl.DataSource = KVPair.GetKVPair("sp_NCIPL_getCollections");
