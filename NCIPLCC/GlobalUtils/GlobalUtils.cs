...
namespace PubEnt.GlobalUtils
{
    ...
    public class Utils
    {
        ...
        public string GetTabHtmlMarkUp(string pubsincart, string pagename)
        {
            ...
            litText1 += @"<span id=shopcarditem>" + carttext + "</span>"; //yma add this shopcarditem to fix a bug that cart not populated when user click order button


            //litText1 += @"<a href=""cart.aspx"" class=""btn viewCart"">View Cart</a>";
            litText1 += @"<a href=""cart.aspx"" class=""btn viewCart"" >";
            litText1 += @"View Cart</a>";
            litText1 += @"</div>";
            ...
            else
            {
                ...
                litText4 = @"<div id=""ordersearchnav""><a href=" + "\"" + orderhistorypagename + "\"" + ">Look up an order</a></div>";
                //litText4 += separator;
            }
