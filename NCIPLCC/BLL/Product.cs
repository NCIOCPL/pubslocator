...
namespace PubEnt.BLL
{
    ...
    public class Product
    {
        ...
        private string _kindleurl; //yma add this
        private string _epuburl; //yma add this
        private string _translation; //yma add this
        ...
        {
            get { return _kindleurl; }
            set { _kindleurl = value; }
        }
        ...
        {
            return (PubEnt.DAL.DAL.LMGetCartPubByPubID(pubid));
        }
        public static ProductCollection GetPubsByCSV(string csv)
        {
            return (PubEnt.DAL.DAL.GetProductsByCSV(csv));
        }
