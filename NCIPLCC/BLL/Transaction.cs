...
/// </summary>
    ...
    public class Transaction{
        ...
        public bool LMSave(string s, string pubids, string pubqtys, out int returnvalue, out int returnordernum)
        {
            return (PubEnt.DAL2.DAL.LMSaveNewOrder(this, s, pubids, pubqtys, out returnvalue, out returnordernum));
        }
        public bool Update(string s, string CurrCustID, string pubids, string pubqtys, out int returnvalue, out int returnordernum)
        {
            return (PubEnt.DAL2.DAL.UpdateOrder(this, CurrCustID, s, pubids, pubqtys, out returnvalue, out returnordernum));
        }
