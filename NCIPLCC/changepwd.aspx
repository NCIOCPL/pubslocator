...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="indentwrap" id="changepw">
        ...
        <div id="divChangePwd" class="ctable clearFix" runat="server">
            ...
            <div class="clearFix">
                <asp:Button ID="btnUpdate" runat="server" class="btn goAction" OnClick="btnUpdate_Click"
                    Text="Update" />
            </div>
            <h3>
            ...
            <div class="clearFix">
                ...
                <asp:Button ID="btnCancel" runat="server" class="btn" Text="Cancel" Visible="false" />
            </div>
