<%@ Page Title="" Language="C#" MasterPageFile="~/pubmaster.Master" AutoEventWireup="true" CodeBehind="newupdated.aspx.cs" Inherits="NCIPLex.newupdated" %>
                        ...
                        CssClass="err"></asp:Label><div class="poporder">
                            ...
                            <div class="qty">
                                ...
                                <asp:Panel ID="pnlPubOrderQuantity" runat="server" DefaultButton="PubOrderOK">
                                                            <asp:TextBox ID="QuantityOrdered" runat="server" Style="text-align: right" MaxLength="4"
                                                                EnableViewState="False" Text="1" Width="40%"></asp:TextBox>
                                </asp:Panel>
