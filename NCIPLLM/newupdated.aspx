<%@ Page Title="" Language="C#" MasterPageFile="~/pubmaster.Master" AutoEventWireup="true"
    CodeBehind="newupdated.aspx.cs" Inherits="PubEnt.newupdated" %>
                            ...
                            <div class="serpcols">
                                ...
                                <div class="col serpdet">
                                    ...
                                    <asp:Label ID="ProductFormat" runat="server" Text="" CssClass="textDefault"></asp:Label>
                                                    <asp:Label ID="BookStatus" runat="server" Text="" CssClass="textDefault"></asp:Label>
                                                    <asp:Label ID="CCLimit" runat="server" Text="" CssClass="textDefault"></asp:Label>
                                                    <asp:Label ID="LMLimit" runat="server" Text="" CssClass="textDefault"></asp:Label>
