...
namespace PubEnt.BLL
{
    ...
    public class ProductCollection:CollectionBase
    {
        ...
        {
            get { return _rntnumber; }
            set { _rntnumber = value; }
        }
        ...
        public bool SameShipBill
        {
            get { return _sameshipbill; }
            set { _sameshipbill = value; }
        }
    }
}
