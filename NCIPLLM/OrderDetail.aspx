...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="indentwrap" id="orderdetail">
        ...
        <div class="orderdetails">
            <asp:Label runat="server" ID="lbltxtInvoice"  CssClass="orderdetailslabel" Text="Invoice" />
            <asp:Label runat="server" ID="lblInvoice" Text="" />
            <asp:Label runat="server" ID="lbltxtOrderSource" CssClass="orderdetailslabel"  Text="Order Source" />
            <asp:Label runat="server" ID="lblOrderSource" Text="" />
        </div>
        <div class="orderdetails">
            <asp:Label runat="server" ID="lbltxtOrderCreator"  CssClass="orderdetailslabel" Text="Order Creator" />
            <asp:Label runat="server" ID="lblOrderCreator" Text="" />
            <asp:Label runat="server" ID="lbltxtTypeofCustomer"  CssClass="orderdetailslabel" Text="Type of Customer" />
        ...
        <div class="orderdetails">
            <asp:Label runat="server" ID="lbltxtCreated" CssClass="orderdetailslabel" Text="Order Created" />
            <asp:Label runat="server" ID="lblCreated" Text="" />
            <asp:Label runat="server" ID="lbltxtDownload" CssClass="orderdetailslabel" Text="Downloaded" />
            <asp:Label runat="server" ID="lblDownload" Text="" />
        </div>
        <div class="orderdetails">
            <asp:Label runat="server" ID="lbltxtShipped" CssClass="orderdetailslabel" Text="Order Status" />
            <asp:Label runat="server" ID="lblShipped" Text="" />
            <asp:Label runat="server" ID="lbltxtTracking" CssClass="orderdetailslabel" Text="Tracking Number" />
            <asp:Label runat="server" ID="lblTracking" Text="" /></div>
        <div class="orderdetails">
            <asp:Label runat="server" ID="lbltxtShipMethod" CssClass="orderdetailslabel" Text="Ship Method" />
        ...
        <asp:Button ID="btnReturn" runat="server" CssClass="btn goAction" OnClick="btnReturn_Click"
            Text="Previous Page" />
    </div>
</asp:Content>
