...
namespace PubEnt
{
    public partial class cart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (Session["NCIPL_Pubs"].ToString() == "" && Request.QueryString["debug"] == "yes")
            //{
            //    Session["NCIPL_Pubs"] = "1292,";
            //    Session["NCIPL_Qtys"] = "1,";
            //    Session["NCIPL_User"] = "lm@test.com";
            //    Session["NCIPL_Role"] = "NCIPL_LM";
            //}
            #endregion
        ...
        protected void UpdateQty(object sender, EventArgs e)
        {
            ...
            string msg = "";
            if (!objUtilMethod.IsTotalQtyValidForRoleForCart(pubs, qtys, out msg))
            {
                Label MessageLabel = new Label();
                MessageLabel.ID = "cartmsglabelid";
                MessageLabel.Text = msg;
                MessageLabel.ForeColor = System.Drawing.Color.Red;
                MessagePlaceHolder2.Controls.Add(MessageLabel);
                return;
            }
            objUtilMethod = null;
            //End NCIPL_CC checks
        ...
        {
            //***EAC I dont know what this is for 9/10/2012
