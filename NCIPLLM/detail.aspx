...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="detailscontainer">
        ...
        <div id="detailsctr">
         ...
         <div class="detailrow">
         <asp:Label ID="Label1" runat="server" Text="Book status:&nbsp;"></asp:Label>
         <asp:Label ID="lblBookStatus" runat="server" CssClass="detailemphasis"></asp:Label></div>
         <div class="detailrow">
         <asp:Label ID="lblPOSInstructionsText" runat="server" Text="POS Instructions:&nbsp;"></asp:Label>
         <asp:Label ID="lblPOSInstructions" runat="server" Text="" CssClass="detailemphasis"></asp:Label></div>
            ...
            <asp:UpdatePanel ID="UpdatePanelOrderPub" runat="server">
                <ContentTemplate>
                    <asp:Label ID="labelErrMsgPubOrder" runat="server" Text="" EnableViewState="False"
                        ...
                        <asp:TextBox ID="QuantityOrdered" runat="server" style="text-align:right" 
						MaxLength="6" EnableViewState="False" Text="1" Width="50%"></asp:TextBox>
                                </asp:Panel>
                                    <span style="display:none; visibility:hidden;">
									<asp:Label runat="server" ID="lblPubQtyLimit" AssociatedControlID="PubQtyLimit"
									 Text="Limit"/></span>
                        ...
                        <tr>
                            ...
                            <td class="cqty">
                                ...
                                <asp:Panel ID="pnlPubCoverOrderQuantity" runat="server" DefaultButton="PubCoverOrderOK">
                                    <asp:TextBox ID="QuantityOrderedCover" runat="server" 
									MaxLength="4" Text="1" EnableViewState="False"
