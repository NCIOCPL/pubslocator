    ...
    {   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {               
                ...
                if (Session["JSTurnedOn"] != null && string.Compare(Session["JSTurnedOn"].ToString(), "False") == 0) //No JavaScript - display all data
                {
        ...
        protected void DisplayModalPopUp(object sender, CommandEventArgs e)
        {
            ...
            if (Session["JSTurnedOn"] != null && string.Compare(Session["JSTurnedOn"].ToString(), "False") == 0)
            {
