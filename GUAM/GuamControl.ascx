    ...
    <asp:PlaceHolder ID="phSetQuestions" runat="server">
        ...
        <fieldset>
            ...
            <asp:Repeater id="repQuestions" runat="server">
                <ItemTemplate>
                    <li>
                        <asp:DropDownList id="ddlQuestions" DataSource='<%# Questions %>' Width="375px" DataValueField="QuestionID" DataTextField="QuestionText" AppendDataBoundItems="true" runat="server">
