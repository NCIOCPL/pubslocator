...
function AddSites {
    ...
    Set-WebConfigurationProperty -Filter $WinAuthentication -Name "enabled" -Value false -Location "PubsAdmin"
        ...
        New-WebApplication -Name "NCIPLAdmin" -Site "PubsAdmin" -PhysicalPath "$RootFilePath\NCIPLAdmin" -ApplicationPool "PubsAdmin" 
            #Set-WebConfigurationProperty -Filter $AnonAuthentication -Name "enabled" -Value false -Location "PubsAdmin/NCIPLAdmin"
            #Set-WebConfigurationProperty -Filter $BasicAuthentication -Name "enabled" -Value true -Location "PubsAdmin/NCIPLAdmin"
