...
/// </summary>
    ...
    public class Transaction{
        ...
        public bool Save(string ipaddr, int confid, out int returnvalue, out int returnordernum)
        {            
            return (PubEnt.DAL2.DAL.SaveNewOrder(this, ipaddr, confid, out returnvalue, out returnordernum));
        }
