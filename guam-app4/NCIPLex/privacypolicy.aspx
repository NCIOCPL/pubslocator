<%@ Page Title="" Language="C#" MasterPageFile="~/pubmaster.Master" AutoEventWireup="true"
    CodeBehind="privacypolicy.aspx.cs" Inherits="NCIPLex.privacypolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="help" class="indentwrap">
        ...
        <h2>
            <a id="top"></a>Privacy Policy - NCI Publications Locator for Exhibits</h2>
        ...
        <p class="textSerpExplain">
            ...
            visit the NCI Publications Locator for Exhibits, contact us, and place orders.</p>
        <p class="textSerpExplain">
        ...
        <h3>
            <a id="auto"></a>What information do we collect automatically?</h3>
        <p>
            When you visit our website, we automatically collect information that does not identify
            you personally. We use Adobe Omniture Web Analytics to help us collect this information.</p>
        <p>
        ...
        <p>
            We use this information to learn how to make our site more useful. We do not use
            this information to identify individual visitors.</p>
        <p class="backlink">
            <a href="#top">back to top</a>
        </p>
        <h3>
            <a id="contact"></a>If you contact us, what information do we collect?</h3>
        <p>
        ...
        <h3>
            <a id="order"></a>If you place an order, what information do we collect?</h3>
        <p>
        ...
        <h3>
            <a id="retention"></a>How long do we keep your information?
        </h3>
        <ul>
            <li>We keep the information we collect automatically from Adobe Omniture only as long
                as required by law or needed to support the mission of the NCI website. </li>
        ...
        <h3>
            <a id="share"></a>Do we share the information we collect?</h3>
        <p>
        ...
        <h3>
            <a id="cookies"></a>Do we use cookies or other tracking devices?</h3>
        <p>
        ...
        <p>
            You can block cookies in your browser by <a href="http://www.usa.gov/optout_instructions.shtml">
                opting out</a>. If you block cookies, you might not be able to order publications
            online. You can still <a href="nciplexhelp.aspx#contact">contact us</a> to place
            an order.</p>
        <p class="backlink">
            <a href="#top">back to top</a>
        </p>
        <h3>
            <a id="security"></a>Is this site secure?</h3>
        <p>
