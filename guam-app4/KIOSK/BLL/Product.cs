...
namespace PubEnt.BLL
{
    ...
    public class Product
    {
        ...
        public bool IsPhysicalItem  //Physical=ORDERable items, otherwise EMAIL-items (20130411)
        {
            get { return _isphysicalitem; }
            set { _isphysicalitem = value; }
        }
        public string Url
        {
            get { return _url; }
        ...
        {
            return (PubEnt.DAL.DAL.GetPubByProductID(productid));
        }
        public static Product GetPubByPubID(int pubid)
        {
            return (PubEnt.DAL.DAL.GetPubByPubID(pubid));
        }
