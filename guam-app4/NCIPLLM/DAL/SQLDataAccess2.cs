...
namespace PubEnt.DAL2
{
    ...
    public class DAL
    {
        ...
        public static int getNoShipFlag(string addr1, string zip5)
        {
            int NoShip = 0;
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cw = db.GetStoredProcCommand("sp_NCIPLCC_getNoShipFlag");     //***EAC 20130214 ok to use nciplcc version
            db.AddInParameter(cw, "addr1", DbType.String, addr1);
            db.AddInParameter(cw, "zip5", DbType.String, zip5);
        ...
        public static Person GetBillingInfo(string username)
        {
            ...
            //***EAC Otherwise returns a blank Person object if username is not found
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetStoredProcCommand("sp_NCIPL_getBillingInfoByUsername"); //***EAC 20130214 ok to use ncipl version
            db.AddInParameter(dbCommand, "username", DbType.String, username);
            using (IDataReader dr = db.ExecuteReader(dbCommand))
            {
                Person p = new Person();
        ...
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cw = db.GetStoredProcCommand("sp_NCIPL_GetEbookUrl");     //***EAC 20130214 ok to use ncipl version
        ...
        public static string GetCountryByID(string cid)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cw = db.GetStoredProcCommand("sp_NCIPLLM_GetCountryByID");
            db.AddInParameter(cw, "cid", DbType.String, cid);
            using (IDataReader dr = db.ExecuteReader(cw))
            {
                if (dr.Read())
        ...
        public static int GetCCUserLimit(string ProductId)
        {
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand cmd = db.GetStoredProcCommand("sp_NCIPLLM_GetCCUserLimit");
