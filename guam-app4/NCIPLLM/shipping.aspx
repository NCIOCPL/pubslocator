    ...
    <div class="indentwrap" id="ship">
        ...
        <asp:Panel ID="pnlSource" runat="server" CssClass="clearFix">
            ...
            <div class="shipsection large">
                <asp:Label ID="lblCustomerType" runat="server" Text="Type of Customer *" AssociatedControlID="drpCustomerType"
                    CssClass="shiplabel"></asp:Label>
            ...
            <div class="shipsection">
                <asp:Label ID="lblOrderSource" runat="server" Text="Order Source *" AssociatedControlID="drpOrderMedia"
                    CssClass="shiplabel"></asp:Label>
            ...
            <div class="shipsection">
                <asp:Label ID="lblOrderComment" runat="server" Text="Comment" AssociatedControlID="txtOrderComment"
                    CssClass="shiplabel"></asp:Label>
                <asp:TextBox ID="txtOrderComment" runat="server" MaxLength="500" Rows="3" TextMode="MultiLine"
                    CssClass="shiptextfield"></asp:TextBox>
            </div>
        </asp:Panel>
        <p>
            * Required field
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtzip5"
                                Display="Dynamic" ErrorMessage="Check ZIP Code" ValidationExpression="\d{5}"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtstate"
                                ErrorMessage="Missing State" EnableClientScript="False"> *</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="labelDefault">
                            <asp:Label runat="server" ID="Label3" AssociatedControlID="drpCountry" Text="Country" />
                            *
                        </td>
                        <td>
            ...
            <div class="addr billaddr">
                ...
                <asp:Panel ID="pnlBIllingInfo" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt2zip5" runat="server" CssClass="addrfieldz5" AutoPostBack="True"
                                    MaxLength="10" OnTextChanged="BillZip_Changed"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txt2zip5"
                                    Display="Dynamic" ErrorMessage="Check the Billing ZIP Code" ValidationExpression="\d{5}"
                                    EnableClientScript="False"> *</asp:RegularExpressionValidator>
                        ...
                        <tr>
                            <td class="labelDefault">
                                <asp:Label runat="server" ID="Label2" AssociatedControlID="drp2Country" Text="Country" />
                                *
                            </td>
                            <td>
                                <asp:DropDownList ID="drp2Country" runat="server">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtAccountNumber"
                                ErrorMessage="Shipping Number is required" EnableClientScript="False">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="txtAccountNumber2"
                                ErrorMessage="Confirmation of Shipping Number is required" EnableClientScript="False">*</asp:RequiredFieldValidator>
