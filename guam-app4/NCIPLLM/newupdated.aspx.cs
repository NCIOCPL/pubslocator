    ...
    {   
        ...
        {  
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                Label PublicationNumber = (Label)e.Item.FindControl("PublicationNumber");
                ...
                //PubIdCover.Value = ProductItem.PubIdCover.ToString();  //yma
                ...
                if (true)   //***EAC this used to be "if ProductItem.Canview == 1"
                {
                ...
                //Check whether this pub is already in cart //yma quoted it
