...
namespace PubEnt
{
    public partial class newupdated : System.Web.UI.Page
    {   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //yma make this redirect
            Response.Redirect("searchres.aspx" + "?newupt=1");
            //Missing Session
        ...
        //    //if (QuantityOrdered.Text.Length > 4) yma enlarge it 
        //    if (QuantityOrdered.Text.Length > 6)
        //        Response.Redirect("default.aspx?redirect=newupdated1", true);
        //    else if(PubQtyLimit.Text.Length > 6)
        //        Response.Redirect("default.aspx?redirect=newupdated2", true);
        //    else if(QuantityOrderedCover.Text.Length > 5)
        //        Response.Redirect("default.aspx?redirect=newupdated3", true);
        //    else if (CoverQtyLimit.Text.Length > 6)
        //        Response.Redirect("default.aspx?redirect=newupdated4", true);
        ...
        //    if (!IsPostBack)
        //    {
        //        //PubOrderOK.OnClientClick = String.Format("return fnPostBack('{0}','{1}','{2}','{3}','{4}','{5}')", PubOrderOK.UniqueID, "", QuantityOrdered.ClientID, PubQtyLimit.ClientID, labelErrMsgPubOrder.ClientID, PubOrderModalPopup.BehaviorID);
        //        //Not working PubOrderOK.Attributes.Add("OnClick", "return fnPostBack(" + "'" + PubOrderOK.UniqueID + "','" + "','" + QuantityOrdered.ClientID + "','" + PubQtyLimit.ClientID + "','" + labelErrMsgPubOrder.ClientID + "','" + PubOrderModalPopup.BehaviorID + "')");
        //        //Not working, look later if time permits PubOrderOK.OnClientClick = String.Format("fnPostBack('{0}','{1}','{2}','{3}','{4}','{5}')", PubOrderOK.UniqueID, "", QuantityOrdered.ClientID, PubQtyLimit.ClientID, labelErrMsgPubOrder.ClientID, PubOrderPanel.ClientID);
        ...
        //            //Begin CR-30: HITT 8719 - Pub Translations [Note: Look at line 444 also if something is to be changed]
