...
namespace PubEnt.GlobalUtils
{
    ...
    public class Utils
    {
        ...
        {
            //***EAC Code copied from verify.aspx.cs 
        ...
        public string GetTabHtmlMarkUp(string pubsincart, string pagename)
        {
            ...
            //string carttext = "";
            //if (intTotalNum == 1)
            //    carttext = "1 <span class='show-for-large-up'>item in your cart </span>";
            //else
            //    carttext = intTotalNum.ToString() + " <span class='show-for-large-up'>items in your cart </span> ";
            //carttext = "10000 Items in your cart ";
            //string separator = @"<div class=""separator""></div>";

            litText1 = @"<div id=""cartnav"">";
            //litText1 += @"<img alt=""Cart"" src=""images/cart.gif"" />";
            
            //litText1 += @"<span>" + carttext + "</span>";
            //litText1 += @"<a href=""cart.aspx"" class=""btn viewCart"">View Cart</a>";
            litText1 += @"<a href=""cart.aspx"" class=""btn viewCart"" onclick=""javascript:_gaq.push(['_trackEvent','Ordering','Submit','View Cart']);NCIAnalytics.PubsLinkTrack('View Cart', this);"">";
            litText1 += @"Cart";
            ////yma add id for span to dynamically populate it from js
            litText1 += @"<span id=""shopcarditem""> (" + intTotalNum + ")</span>";
            litText1 += @"</a></div>";
            //litText1 += separator;
            //litText2 = @"<a href=""nciplhelp.aspx"">Help with ordering</a>: 1-800-4-CANCER (1-800-422-6237)";            
            //litText2 += separator;
            ...
            if (boolSaveSearch)
            {
                ...
                if (!IsAdvSearch)
                {
                    PubEnt.DAL2.DAL.SaveSearchCriteriaText(HttpContext.Current.Session["PUBENT_SearchKeyword"].ToString(), Hits,
                                                            ...
                                                            HttpContext.Current.Session["PUBENT_RaceCriteria"].ToString(), "NCIPL");
