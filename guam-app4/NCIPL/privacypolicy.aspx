<%@ Page Title="Privacy Policy - NCI Publications Locator" Language="C#" MasterPageFile="~/pubmaster.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="help" class="indentwrap">
        ...
        <h2>
            <a id="top"></a>Privacy Policy - NCI Publications Locator
        </h2>
        ...
        <p class="textSerpExplain">
            ...
            visit the NCI Publications Locator, contact us, and place orders.
        </p>
        <p class="textSerpExplain">
            ...
            Facebook, YouTube), please visit the overall NCI <a class="fontsizeinherit" href="http://www.cancer.gov/global/web/policies/privacy">Privacy and Security Policy</a>.
        </p>
        ...
        <p>
            ...
            use this information to identify individual visitors.
        </p>
        <h3>
        ...
        <ul>
            <li>We will use the information you give us to respond to your request and to improve
                our service.</li>
            <li>We will contact you only to respond to your request.</li>
        </ul>
        <h3>
        ...
        <p>
            You can block cookies in your browser by <a href="http://www.usa.gov/optout-instructions.shtml">opting out</a>. If you block cookies, you might not be able to order publications
        ...
        <p>
            ...
            it is sent to us over the Internet.
        </p>
        <p>
        ...
        <p class="contentdate">
            <strong>Updated:</strong> 6/1/2013
        </p>
    </div>
</asp:Content>
