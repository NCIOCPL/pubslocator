...
namespace PubEnt.DAL2
{
    ...
    public class DAL
    {
        ...
        //public static bool SaveOrder(Transaction t, string s, string pubids, string pubqtys, out int returnvalue)
        //{
        ...
        public static DateTime MostRecentOrder(string addr1, string zip5)
        {
            ...
            db.AddInParameter(cw, "addr1", DbType.String, addr1.Trim());
            db.AddInParameter(cw, "zip5", DbType.String, zip5.Trim());
        ...
        public static bool SaveNewOrder(Transaction t, string ipaddr, string pubids, string pubqtys, out int returnvalue, out int retordernum)
        {
            ...
            {
                Database db = DatabaseFactory.CreateDatabase();
                DbCommand cw = db.GetStoredProcCommand("sp_NCIPL_SaveNewOrder");
                ...
                db.AddInParameter(cw, "ordersource", DbType.String, "IWEB");                //always 'IWEB' for NCIPL
                db.AddInParameter(cw, "bopolicy", DbType.String, "O");                      //always 'O' for NCIPL               
