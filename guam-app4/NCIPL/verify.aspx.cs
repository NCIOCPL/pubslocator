    ...
    public partial class verify : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string interfacename = "NCIPL"; //NCIPL, ROO or EXHIBIT
        ...
        protected void UPS(Person p)
        {
            ...
            try
            {
                ...
                if (xavResponse.ItemElementName != UPSAddressValidation.ItemChoiceType.ValidAddressIndicator)   //***EAC TODO: if (xavResponse.says_address_is bad  ValidAddressIndicator, AmbiguousAddressIndicator,NoCandidatesIndicator	
                {
        ...
        {
            //**EAC TODO: Dont just focus on the 30 days.  You need to check if an order was placed in the current month! (20130222)
