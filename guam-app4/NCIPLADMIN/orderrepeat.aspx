<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderrepeat.aspx.cs" Inherits="PubEntAdmin.orderrepeat" %>
    ...
    <div id="container">
        ...
        <form id="cssetupform" runat="server">
            ...
            <div id="mainBody">
                <div id="dvSearch">
                    <fieldset>
                        <legend class="Legend1">Repeat Orders</legend>
